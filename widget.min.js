...
(function (root, factory) {
    ...
    var DateRangePicker = function(element, options, cb) {
        ...
        if (typeof options.template !== 'string' && !(options.template instanceof $))
            options.template = '<div class="daterangepicker rootrez-dropdown-menu">' +
    ...
    DateRangePicker.prototype = {
        ...
        renderCalendar: function(side) {
            ...
            if ((!minDate || minDate.isBefore(calendar.firstDay)) && (!this.linkedCalendars || side == 'left')) {
                html += '<th class="prev available"><svg class="icon icon-prev"><use xlink:href="#icon-prev"></use></svg></th>';
            } else {
                html += '<th></th>';
            }
            ...
            if ((!maxDate || maxDate.isAfter(calendar.lastDay)) && (!this.linkedCalendars || side == 'right' || this.singleDatePicker)) {
                html += '<th class="next available"><svg class="icon icon-next"><use xlink:href="#icon-next"></use></svg></th>';
            } else {
                html += '<th></th>';
            }
        ...
        move: function() {
            ...
            if (this.opens == 'left') {
                ...
                if (this.offsetLeft !== false) {
                    containerLeft = this.offsetLeft;
                } else {
